...
let handlefoodClick = foodId => {
    fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${ foodId }`)
        ...
        .then(data => {
            ...
            <br>
            <h3>☑️ ${ data.meals[0].strMeasure1 }</h3>
            <h3>☑️ ${ data.meals[0].strMeasure2 }</h3>
            <h3>☑️ ${ data.meals[0].strMeasure3 }</h3>
            <h3>☑️ ${ data.meals[0].strMeasure4 }</h3>
            <h3>☑️ ${ data.meals[0].strMeasure5 }</h3>
            <h3>☑️ ${ data.meals[0].strMeasure6 }</h3>
            `;
